...
export function WebsiteCms({ siteId, sections: initialSections, canEdit, loadStatus, loadDetail }: {
  ...
  const publishPage = async () => {
    ...
    try {
      ...
      setMessage(failed?.message || "Page published to the website.");
