...
import { beats } from "@/lib/control-center/data";
...
export default function BeatLibraryPage() {
  return (
    <>
      <PageHeader eyebrow="Catalog" title="Beat Library" description="Search, review, and organize the JMT Music catalog. Uploading and editing arrive in the next phase." actions={<ActionButton primary><Plus className="h-4 w-4" /> Add Beat</ActionButton>} />
