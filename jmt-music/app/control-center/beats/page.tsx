...
/** Property-scoped beat catalog with authorized create and edit workflows. */
export default async function BeatLibraryPage({ searchParams }: SitePageProps) {
  ...
  return (
    <>
      <PageHeader eyebrow={`${site.name} · Catalog`} title={site.catalogTitle} description={site.catalogDescription} actions={<AddBeatDialog propertyId={site.id} disabled={!access.canCreate || site.id !== "jmt-music"} />} />
